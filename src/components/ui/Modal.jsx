  ...
  return createPortal(
    ...
    >
      ...
      <Motion.div
        ...
        tabIndex={-1}
        className={`relative z-[111] max-h-[calc(100vh-2rem)] w-full overflow-hidden rounded-md border border-[var(--line)] bg-[var(--surface)] ${SIZE_CLASSES[size] || SIZE_CLASSES.md}`}
